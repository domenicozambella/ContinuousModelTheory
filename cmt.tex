...
At face value the following fact may sound stronger then it is in reality.
In fact, though we prove a form of compactness for ${\EuScript J}$-formulas, this may be only applied as in Fact~\ref{fact_compactness_imp}.
Hence there is no way to conclude that $\{\varphi(x)\}'$ is finite.
...
Our goal is to prove the Compactness Theorem for ${\EuScript J}$.
