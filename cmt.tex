...
It is clear that ${\EuScript I}$-elementarity implies its approximated version, similarly for ${\EuScript H}$-elementarity.
...
Let $k:M\to N$ an approximate ${\EuScript I}$-elementary map between to $|k|^+$-${\EuScript I}$-saturated models of $T^{\rm pfr}$.
Then for every $b\in M$ there is a $c\in N$ such that $k\cup\{\langle b,c\rangle\}:M\to N$ is an approximate ${\EuScript I}$-elementary map.
