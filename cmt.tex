...
\begin{proof}
  ...
  Let $\langle ^*M,^*I\rangle$ be a ${\EuScript L}$-saturted ${\EuScript L}$-saturated superstructure of $\langle M,I\rangle$.
  Then $\langle ^*M,^*I\rangle\models\varphi(a\,;\alpha)$ for some $\alpha\in ^*I$.
  By Lemma~\ref{lem_st}, $^*M\models\varphi(a\,;{\rm st}(a))$.
  Now observe that the truth of formulas without quantifiers of sort ${\sf H}$ is preserved in substructures.
\end{proof}
...
\ceq{2.\hfill\beta_i}{=}{\Pr\big(\exists x\,\varphi_i(x,\hat a)\big)}
