...
Now we introduce a two of weak notions of elementarity.
It will be easy to see that they are invertible in all models.
...
We will prove that within saturated models there is no difference between approximately $\mathds{I}$ and $\mathds{H}$-elementary maps -- they are are both ${\EuScript L}$-elementary.
...
\begin{comment}
The proof of the following proposition uses the same compactness argument used for Proposition~\ref{prop_LHapprox1}.
...
Therefore the definition of Cauchy sequence, and the corresponding notion of completeness, makes perfectly sense in $U$.
