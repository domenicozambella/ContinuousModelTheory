...
The most common examples of structures $I$ are the unit interval $[0,1]$, with the usual topology, and its homeomophic copies $\mathds{R}^+\cup\{\infty\}$ and $\mathds{R}\cup\{\pm\infty\}$.
...
Note that this is the same as requireing that (1) holds for all formulas without quantifiers of sort ${\sf H}$.
...
\begin{proof}
  ...
  \ceq{1.\hfill t(a,a_\lambda,z)}{=}{t(b,a_\lambda,z).}

  As $a_\lambda\sim_{\sf I}\!b_\lambda$ then

  \ceq{\hfill t(x,a_\lambda,z)}{=}{t(x,b_\lambda,z)}

  and in particular 

  \ceq{2.\hfill t(b,a_\lambda,z)}{=}{t(b,b_\lambda,z).}

  From (1) and (2) we obtain

  \ceq{\hfill t(a,a_\lambda,z)}{=}{t(b,b_\lambda,z).}

  For limit ordinals induction is trivial.
\end{proof}

Note that the approximation of the formula $x\sim_t\!y$ has the form
...
\begin{itemize}
  \item[1.] every ${\sf I}$-invariant Cauchy type $p(x)\subseteq\mathds{I}(M)$ is realized in $B$
