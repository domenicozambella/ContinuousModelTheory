...
\begin{example}\label{ex_HPP}
  ...
  Let $A\subseteq{\EuScript U}$ have small cardinality.
  Let ${\EuScript L}$ contain, besides $L_{\sf H}$ and $L_{\sf I}$, symbols for the functions $f:{\EuScript U}^n\to{\sf I}$ that are continuous in the following sense: the inverse image of every compact $C\subseteq I$ is $L_{\sf H}$-type-definable over $A$.
